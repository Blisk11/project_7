...
if page == 'Model inputs for cut off explained':
    ...
    useful to understand the trade-off in the true-positive rate and false-positive rate for different thresholds. *Our aim is to "catch" every defaulting customer, 
